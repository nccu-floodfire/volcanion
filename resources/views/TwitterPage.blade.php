<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <script>
            var baseURL = "{!! url('/') !!}";
            function get_list(){
                console.log(baseURL+'/api/twitterindexcategory')
                axios.get(baseURL+'/api/twitterindexcategory')
            ...
            function get_data(category){
                console.log(baseURL+'/api/twittershow/'+category)
                axios.get(baseURL+'/api/twittershow/'+category)
                .then(function(response){
                    console.log('load_status'+response.status)
                    current_item = response.data
                    ...
                    console.log("error : each_data_"+category)
