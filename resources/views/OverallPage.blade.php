<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <script>
            var baseURL = "{!! url('/') !!}";
            function get_list(){
                console.log(baseURL+'/api/overviewcategory')
                axios.get(baseURL+'/api/overviewcategory')
            ...
            function get_data(category){
                console.log(baseURL+'/api/overviewshow/'+category)
                axios.get(baseURL+'/api/overviewshow/'+category)
                .then(function(response){
                    console.log('load_status'+response.status)
                    current_item = response.data
